      ...
      <div className="w-[360px] mx-auto max-sm:w-[90%]">
        ...
        <div className=" 2xl:w-full w-[95%] mt-[2.063rem] max-sm:mt-4">
          <form className="w-full" onSubmit={handleRegisterForm} method="POST">
            ...
            {/* dj btn and user btn */}
            <div className="flex max-xs:space-x-2 mt-4 mb-4 justify-between">
              <button
                onClick={() => {
                  setUserType("dj");
                }}
              ...
              rounded-3xl bg-blue text-center 2xl:mt-[2.063rem]  text-white"
              >
                {isLoading ? (
                  <span>
                    <svg
          ...
          >
            <span className="text-black-dark">Have An Account?</span>
            <span>
